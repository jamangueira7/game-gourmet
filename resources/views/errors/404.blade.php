...
<html lang="pt-br">
    ...
    <body style="background-color: #0565cb;">
    <div style="display: flex;justify-content: center;align-items: center; min-height: 100px; font-size: 100px; font-weight: bold; color: #fff;">
